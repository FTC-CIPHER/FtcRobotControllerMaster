...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1444.7915897539997; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1328.1058024216677; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1915.1512411616843; // x position of the perpendicular encoder (in tick units)
    }
